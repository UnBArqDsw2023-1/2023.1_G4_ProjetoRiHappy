...
| ------ | --------------------------- | ----------- | -------------------------------------------------- | ------------ |
| 1.0    | Criação do documento        | Iago Cabral | Mateus Caltabiano, Matheus Soares e Pedro Henrique | 06/06/2023   |
| 1.1    | Adição de Diagramas         | Felipe Alef | João Correia                                       | 11/06/2023   |
| 1.2    | Adição de trechos do código | Felipe Alef | Mateus Caltabiano, Matheus Soares e Pedro Henrique | 1105/05/2023 |
